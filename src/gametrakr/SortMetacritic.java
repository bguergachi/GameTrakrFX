...
/**
 * <p>
 * Overview: This class is used to sort a list of games base on their metaCritic
 * score. This class extends the GameListAbstraction with no change in the rep
 * invariance invariance and abstract function.
 *
 * @author agsof
 */
public class SortMetacritic extends GameListAbstraction {

    /**
     * <p>
     * EFFECT: Returns a sorted list of Games by metaCritic
     * <p>
     ...
     * the Game property metaCritic
     *
     * @param gameList
     */
    @Override
    public void sort(GameListImplementation gameList) {
        Collections.sort(gameList.getGames, new MetacriticComparator());
    }
}
